...
viruses = {0: {'infected': 'no', 'exposed': 'no', 'initial_outbreak_size': 1, 'spread_chance': 1, 'exposed_chance': 1, 'skeptical_level': 2, 'opposite_virus': 1},
           1: {'infected': 'no', 'exposed': 'no', 'initial_outbreak_size': 1, 'spread_chance': 1, 'exposed_chance': 1, 'skeptical_level': 2, 'opposite_virus': 0}}
...
class VirusOnNetwork(mesa.Model):
    ...
    def __init__(
        ...
        skeptical_level_virus_0=1,
        skeptical_level_virus_1=1,
    ):
        self.misinformation = {0: {'infected': 'no', 'exposed': 'no', 'initial_outbreak_size': 1, 'spread_chance': 1, 'exposed_chance': '27', 'skeptical_level': 2, 'opposite_virus': 1},
                               1: {'infected': 'no', 'exposed': 'no', 'initial_outbreak_size': 1, 'spread_chance': 1, 'exposed_chance': '27', 'skeptical_level': 2, 'opposite_virus': 0}}
        ...
        self.datacollector = mesa.DataCollector(
            {
                ...
                #'Susceptible': (misinformation[0]['exposed']=='no' and misinformation[1]['exposed']=='no'),
                #'Exposed 1 and Susceptible 2': (misinformation[0]['exposed']=='yes' and misinformation[1]['exposed'])=='no',
                #'Exposed 2 and Susceptible 1': (misinformation[0]['exposed']=='no' and misinformation[1]['exposed'])=='yes',
                #'Exposed Both': (misinformation[0]['exposed']=='yes' and misinformation[1]['exposed'])=='yes',
                #'Infected 1 Susceptible 2': (misinformation[0]['infected']=='yes' and misinformation[1]['exposed'])=='no',
                #'Infected 2 Susceptible 1': (misinformation[0]['exposed']=='no' and misinformation[1]['infected'])=='yes',
                #'Infected 1 Exposed 2': (misinformation[0]['infected']=='yes' and misinformation[1]['exposed'])=='yes',
                #'Infected 2 Exposed 1': (misinformation[0]['exposed']=='yes' and misinformation[1]['infected'])=='yes',
                #Skeptical': number_skeptical,
            }
        )
...
class VirusAgent(mesa.Agent):
    ...
    def __init__(
        ...
        self.misinformation = {0: {'infected': 'no', 'exposed': 'no', 'initial_outbreak_size': 2, 'spread_chance': 4, 'exposed_chance': 3, 'skeptical_level': 2, 'opposite_virus': 1},
